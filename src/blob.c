...
static void
pysqlite_Blob_dealloc(pysqlite_Blob *self)
{
  // APSW_CLEAR_WEAKREFS;
  // TODO search pysqlite dealloc

  pysqlite_Blob_close_internal(self, 2);
...
static PyObject *
pysqlite_Blob_read(pysqlite_Blob *self, PyObject *args)
{
  int length=-1;
  int res;
  PyObject *buffy=0;
...
static PyObject*
pysqlite_Blob_readinto(pysqlite_Blob *self, PyObject *args)
{
  int length;
  int res;
...
*/
static PyObject *
pysqlite_Blob_write(pysqlite_Blob *self, PyObject *obj)
{
  const void *buffer=0;
  Py_ssize_t size;
  int res;
...
static PyObject *
pysqlite_Blob_close(pysqlite_Blob *self, PyObject *args)
{
  int setexc;
  int force=0;
  ...
  setexc=pysqlite_Blob_close_internal(self, !!force);
...
static PyObject *
pysqlite_Blob_reopen(pysqlite_Blob *self, PyObject *arg)
{
  int res;
  long long rowid;
...
static PyMethodDef pysqlite_Blob_methods[]={
  ...
  {"readinto", (PyCFunction)pysqlite_Blob_readinto, METH_VARARGS,
...
static PyTypeObject pysqlite_BlobType = {
    ...
    "pysqlcipher blob object",        /* tp_doc */
    0,		                   /* tp_traverse */
    0,		                   /* tp_clear */
    0,		                   /* tp_richcompare */
    offsetof(pysqlite_Blob, weakreflist), /* tp_weaklistoffset */
    0,		                   /* tp_iter */
    0,		                   /* tp_iternext */
    pysqlite_Blob_methods,     /* tp_methods */
    0,                         /* tp_members */
    0,                         /* tp_getset */
    0,                         /* tp_base */
    0,                         /* tp_dict */
